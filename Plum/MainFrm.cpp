...
const UINT login_btnID = WM_USER + 200;
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_WM_SETTINGCHANGE()
	ON_BN_CLICKED(login_btnID, &CMainFrame::loginBtn_down)
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_login.Create(L"登录", WS_CHILD | WS_VISIBLE, rect, this, login_btnID);
